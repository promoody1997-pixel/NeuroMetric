...
public class GameActivity extends AppCompatActivity {
    ...
    private void startGame() {
        ...
        // 0 = أحمر، 1 = أزرق
        if (colorIndex == 0) {
            colorText.setText("أزرق"); // الكلمة مخادعة
            colorText.setTextColor(Color.RED); // اللون الحقيقي
            correctColor = Color.RED;
        } else {
            colorText.setText("أحمر"); // الكلمة مخادعة
            colorText.setTextColor(Color.BLUE); // اللون الحقيقي
